...
public class HTKFeatureConfiguration : global::System.IDisposable {
  ...
  public HTKFeatureConfiguration(string streamName, string scp, uint dim, uint left, uint right, bool broadcast, bool definesMbSize) : this(CNTKLibPINVOKE.new_HTKFeatureConfiguration__SWIG_0(streamName, scp, dim, left, right, broadcast, definesMbSize), true) {
    if (CNTKLibPINVOKE.SWIGPendingException.Pending) throw CNTKLibPINVOKE.SWIGPendingException.Retrieve();
  }

  public HTKFeatureConfiguration(string streamName, string scp, uint dim, uint left, uint right, bool broadcast) : this(CNTKLibPINVOKE.new_HTKFeatureConfiguration__SWIG_1(streamName, scp, dim, left, right, broadcast), true) {
    if (CNTKLibPINVOKE.SWIGPendingException.Pending) throw CNTKLibPINVOKE.SWIGPendingException.Retrieve();
  }
